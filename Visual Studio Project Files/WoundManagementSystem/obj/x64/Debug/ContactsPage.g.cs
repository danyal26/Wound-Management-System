...
namespace WoundManagementSystem
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class ContactsPage_obj65_Bindings :
            global::Windows.UI.Xaml.IDataTemplateExtension,
            global::Windows.UI.Xaml.Markup.IComponentConnector,
            IContactsPage_Bindings
        {
            private global::WoundManagementSystem.Contact dataRoot;
            ...
            public ContactsPage_obj65_Bindings()
            {
            }
            ...
            {
                 global::WoundManagementSystem.Contact data = args.NewValue as global::WoundManagementSystem.Contact;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::WoundManagementSystem.Contact was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::WoundManagementSystem.Contact);
                ...
                this.Update_((global::WoundManagementSystem.Contact) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            // ContactsPage_obj65_Bindings

            public void SetDataRoot(global::WoundManagementSystem.Contact newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::WoundManagementSystem.Contact obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_contactId(obj.contactId, phase);
                        this.Update_name(obj.name, phase);
                    }
                }
            }
            private void Update_contactId(global::System.String obj, int phase)
            {
        ...
        private class ContactsPage_obj1_Bindings :
            ...
            IContactsPage_Bindings
        {
            private global::WoundManagementSystem.ContactsPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void SetDataRoot(global::WoundManagementSystem.ContactsPage newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::WoundManagementSystem.ContactsPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_contactList(obj.contactList, phase);
                    }
                }
            }
            private void Update_contactList(global::System.Collections.ObjectModel.ObservableCollection<global::WoundManagementSystem.Contact> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 45:
                {
                    this.BtnModifyContact = (global::Windows.UI.Xaml.Controls.Button)(target);
                    #line 426 "..\..\..\ContactsPage.xaml"
                    ((global::Windows.UI.Xaml.Controls.Button)this.BtnModifyContact).Click += this.BtnModifyContact_Click;
                    #line default
                }
                break;
            case 46:
            ...
            case 63:
                {
                    ...
                    #line 214 "..\..\..\ContactsPage.xaml"
                    ((global::Windows.UI.Xaml.Controls.ListView)this.ContactsListView).ItemClick += this.ListView_ItemClick;
                    #line default
                }
                break;
            case 64:
            ...
            case 72:
                {
                    this.IconContacts = (global::Windows.UI.Xaml.Controls.Image)(target);
                }
                break;
            case 73:
                {
            ...
            case 65:
                {
                    ...
                    ContactsPage_obj65_Bindings bindings = new ContactsPage_obj65_Bindings();
                    returnValue = bindings;
                    bindings.SetDataRoot((global::WoundManagementSystem.Contact) element65.DataContext);
